...
**Previous:** [Phase 2: Range Extension](phase-02-range-extension.html)  
**Next:** [Phase 4: Il Triello](phase-04-il-triello.html)

---

## Skills you need before starting Phase 3

- **From Phase 2:** Reliable high register up to high C with good tone; scale to high C even and in tune; **double tonguing** even and clear at a moderate tempo (if your Phase 2 piece used it); one lyrical piece (e.g. Trumpeter's Lullaby) solid with expression and no stops.
- You're ready for longer, more demanding solos and for polishing dynamics and phrasing.
...
- **Warm-up (5 min):** Long tones, lip slurs, scale to high C.
- **Fundamentals (5 min):** One scale and one flexibility or dynamic exercise.
- **Piece work (20 min):** Problem spots first, then full run-throughs. Use a backing track sometimes.
...
**Sheet music:** [Phase 3 — Lyrical and technical solos](sheet-music-sources.html#phase-3--lyrical-and-technical-solos) (Petite Pièce Concertante, Romance, etc.) and [Concert and Contest Collection](sheet-music-sources.html#collections-useful-for-phase-3).
...
- Record a full run of each piece. Use a checklist: dynamics? phrasing? tone? rhythm? high notes?
- Ask: "Would I be okay playing this for someone else?" If yes, you're ready for Phase 4.

---

## Videos to Watch (Phase 3 Skills)

Each skill links to the video section in [Skills & Video Reference](skills-videos.html):

- **[Dynamics](skills-videos.html#dynamics)** — Playing soft and loud with good tone; crescendo and diminuendo.
- **[Phrasing and expression](skills-videos.html#phrasing-and-expression)** — Shaping phrases, breathing, making it sound musical.
- **Double tonguing (if your piece uses it):** [Double tonguing](skills-videos.html#double-tonguing).

See also the [Skills → Video sections](skills-videos.html#skills--video-sections-quick-links) index.
