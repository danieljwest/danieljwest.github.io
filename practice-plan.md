...
**Video help:** [Skills & Video Reference](skills-videos.html) — curated videos for long tones, lip slurs, high notes, articulation, **double tonguing**, breathing, dynamics, and Il Triello play-along.
...
| Phase | File | Focus |
|-------|------|--------|
| **1** | [phase-01-foundation.md](phase-01-foundation.html) | Tone, air, articulation, comfortable mid-range |
| **2** | [phase-02-range-extension.md](phase-02-range-extension.html) | High register, **double tonguing**, lyrical piece (e.g. Trumpeter's Lullaby) |
| **3** | [phase-03-repertoire.md](phase-03-repertoire.html) | Three specified solos (grade 2–3) with alternatives |
| **4** | [phase-04-il-triello.md](phase-04-il-triello.html) | Learn and perform Il Triello |
...
- **Instrument:** The plan and all note names assume **B♭ trumpet** (written pitch). Sheet music and method books listed are for B♭ trumpet unless noted.
- **Metronome:** App or physical; use daily.
- **Recording:** Phone or tablet; record at least one run of your current piece each week.
- **Sheet music:** See **[sheet-music-sources.md](sheet-music-sources.html)** for specific books and publishers (method books, Faber First/Second Book of Trumpet Solos, Trumpet Stars, Trumpeter's Lullaby, Phase 3 solos, Il Triello). Each phase file links each piece to the right section; [sheet-music-sources](sheet-music-sources.html#pieces--books--sources-quick-links) also has a "Pieces & books → Sources" index at the top.
- **Backing tracks:** Search “[piece name] trumpet backing track” or “[piece name] piano accompaniment” on YouTube or sheet music sites.
- **Videos:** [skills-videos.md](skills-videos.html) — each phase file links skills to the right video section; use the [Skills → Video sections](skills-videos.html#skills--video-sections-quick-links) index at the top.
- **Optional:** A trumpet teacher to check tone, range, and interpretation.

---

## Quick reference: “Am I doing this right?”

- **Tone:** Steady, same volume from start to end of the note; no wobble or buzz.
- **High notes:** Think “ee,” fast air from the stomach; no squeezing the throat or mouthpiece.
- **Articulation:** Clean “too” on each note; rhythm even; use "ta-ka" (double tonguing) for fast passages once introduced in Phase 2.
- **Phrasing:** Breathe at phrase ends; shape the line (a little louder in the middle, softer at the end of the phrase).
- **Ready to move on:** You can play the piece or exercise **three times in a row** correctly, and a **recording** sounds good to you.
...
Full "ready to move on?" and self-assessment steps are in each [phase file](phase-01-foundation.html).
